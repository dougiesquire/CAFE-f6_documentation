...
- Changes to the MOM executable were made while the CAFE-f6 dataset was being generated that impact the reproducibility of some of the May-initialised forecasts. Users are encouraged to review which forecasts are reproducible using the current executable. A simple way to avoid this issue altogether is to use only the November-initialised forecasts.
